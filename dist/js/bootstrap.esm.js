...
class Carousel extends BaseComponent {
  ...
  static carouselInterface(element, config) {
    ...
    let _config = _extends({}, Default$8, Manipulator.getDataAttributes(element));
...
class Collapse extends BaseComponent {
  ...
  static collapseInterface(element, config) {
    ...
    const _config = _extends({}, Default$7, Manipulator.getDataAttributes(element), typeof config === 'object' && config ? config : {});
...
EventHandler.on(document, EVENT_CLICK_DATA_API$3, SELECTOR_FORM_CHILD, e => e.stopPropagation());
/**
 * ------------------------------------------------------------------------
 * jQuery
 * ------------------------------------------------------------------------
...
class Modal extends BaseComponent {
  ...
  static jQueryInterface(config, relatedTarget) {
    return this.each(function () {
      ...
      const _config = _extends({}, Default$5, Manipulator.getDataAttributes(this), typeof config === 'object' && config ? config : {});
...
class Offcanvas extends BaseComponent {
  constructor(element, config) {
    super(element);
    this._config = this._getConfig(config);
    this._isShown = element.classList.contains(CLASS_NAME_SHOW$4);
