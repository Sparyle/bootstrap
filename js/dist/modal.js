...
(function (global, factory) {
  ...
  class Modal extends BaseComponent__default['default'] {
    ...
    static jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        const _config = _extends({}, Default, Manipulator__default['default'].getDataAttributes(this), typeof config === 'object' && config ? config : {});
  ...
  EventHandler__default['default'].on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
    ...
    if (!data) {
      const config = _extends({}, Manipulator__default['default'].getDataAttributes(target), Manipulator__default['default'].getDataAttributes(this));
